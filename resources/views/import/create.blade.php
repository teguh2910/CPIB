                ...
                <div class="mb-6">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                            <button type="button" id="tab-basic" class="tab-button active whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm" data-tab="basic">
                                Basic Information
                            </button>
                            <button type="button" id="tab-details" class="tab-button whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm" data-tab="details">
                                Import Details
                            </button>
                            <button type="button" id="tab-documents" class="tab-button whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm" data-tab="documents">
                                Documents
                            </button>
                            <button type="button" id="tab-additional" class="tab-button whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm" data-tab="additional">
                                Additional Info
                            </button>
                        </nav>
                    </div>
                ...
                <div class="tab-content">
                    ...
                    <div id="documents-content" class="tab-pane hidden">
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="bill_of_lading_number" class="block text-sm font-medium text-gray-700 mb-2">
