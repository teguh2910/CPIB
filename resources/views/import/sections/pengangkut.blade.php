        ...
        <div class="grid grid-cols-1 gap-3">
            ...
            <div class="grid md:grid-cols-2 gap-3">
                ...
                <x-field label="Bendera">
                    <select name="angkut_bendera" id="angkut_bendera"
                        class="w-full border rounded px-3 py-2 negara-select">
        ...
        <div class="grid grid-cols-1 gap-3">
            <div class="grid md:grid-cols-4 gap-3">
                <x-field label="Pelabuhan Muat">
                    <select name="kode_pelabuhan_muat" id="kode_pelabuhan_muat"
                        class="w-full border rounded px-3 py-2 pelabuhan-select">
                ...
                <x-field label="Pelabuhan Transit">
                    <select name="kode_pelabuhan_transit" id="kode_pelabuhan_transit"
                        class="w-full border rounded px-3 py-2 pelabuhan-select">
                        <option value="">-- Pilih --</option>
                ...
                <x-field label="Pelabuhan Tujuan">
                    <select name="kode_pelabuhan_tujuan" id="kode_pelabuhan_tujuan"
                        class="w-full border rounded px-3 py-2 pelabuhan-tujuan-select">
                        <option value="">-- Pilih --</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.tps-select').select2({
                ...
                ajax: {
                    ...
                    data: function(params) {
                        ...
                        // Add import_notification_id if available (for edit mode)
                        @if (isset($importNotification) && $importNotification->id)
                            data.import_notification_id = {{ $importNotification->id }};
                        @endif
            ...
            $('form').on('submit', function() {
                $('.pelabuhan-select, .tps-select, .pelabuhan-tujuan-select, .negara-select').each(
                    function() {
                        var selectedValue = $(this).val();
                        if (selectedValue) {
                            // Ensure the selected option exists in the DOM
                            if ($(this).find('option[value="' + selectedValue + '"]').length === 0) {
                                $(this).append('<option value="' + selectedValue + '" selected>' +
