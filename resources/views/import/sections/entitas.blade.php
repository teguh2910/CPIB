    ...
    <div class="space-y-4">
        ...
        <div class="bg-gray-50 border rounded-xl p-4 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
                <div class="grid md:grid-cols-2 gap-3">
                    ...
                    <x-field label="NPWP">
                        <input name="importir[nomor_identitas]" class="w-full border rounded px-3 py-2"
                            value="{{ old('importir.nomor_identitas', $e['importir']['nomor_identitas'] ?? '001065305305500') }}"
                            required>
                    </x-field>
                    <x-field label="NITKU">
                ...
                <div class="grid md:grid-cols-2 gap-3">
                    <x-field label="Nama">
                        <input name="importir[nama_identitas]" class="w-full border rounded px-3 py-2"
                            value="{{ old('importir.nama_identitas', $e['importir']['nama_identitas'] ?? 'AISIN INDONESIA') }}"
                            required>
                    </x-field>
                ...
                <x-field label="Alamat">
                    <textarea name="importir[alamat_identitas]" class="w-full border rounded px-3 py-2" required>{{ old('importir.alamat_identitas', $e['importir']['alamat_identitas'] ?? 'KAWASAN INDUSTRI EJIP PLOT 5J 000/000 SUKARESMI, CIKARANG SELATAN, BEKASI, JAWA BARAT') }}</textarea>
                </x-field>
        ...
        <div class="bg-gray-50 border rounded-xl p-4 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <x-field label="Alamat">
                    <textarea name="pemusatan[alamat_identitas2]" class="w-full border rounded px-3 py-2" required>{{ old('pemusatan.alamat_identitas2', $e['pemusatan']['alamat_identitas2'] ?? 'KAWASAN INDUSTRI EJIP PLOT 5J 000/000 SUKARESMI, CIKARANG SELATAN, BEKASI, JAWA BARAT') }}</textarea>
                </x-field>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-gray-50 border rounded-xl p-4 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <x-field label="Alamat">
                    <textarea name="pemilik[alamat_identitas3]" class="w-full border rounded px-3 py-2" required>{{ old('pemilik.alamat_identitas3', $e['pemilik']['alamat_identitas3'] ?? 'KAWASAN INDUSTRI EJIP PLOT 5J 000/000 SUKARESMI, CIKARANG SELATAN, BEKASI, JAWA BARAT') }}</textarea>
                </x-field>
            </div>
        </div>
        ...
        <div class="bg-gray-50 border rounded-xl p-4 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <x-field label="Nama (Master)">
                    ...
                    <select id="pengirim_party_id" name="pengirim[nama_identitas4]"
                ...
                <div class="grid md:grid-cols-2 gap-3">
                    <x-field label="Alamat">
                        <textarea name="pengirim[alamat_identitas4]" id="pengirim_alamat" class="w-full border rounded px-3 py-2" required>{{ old('pengirim.alamat_identitas4', $e['pengirim']['alamat_identitas4'] ?? ($ent['alamat_identitas4'] ?? '')) }}</textarea>
                    </x-field>
                    <x-field label="Negara">
                        <select name="pengirim[kode_negara]" id="pengirim_negara"
        ...
        <div class="bg-gray-50 border rounded-xl p-4 space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <x-field label="Nama (Master)">
                    ...
                    <select id="penjual_party_id" name="penjual[nama_identitas5]"
                        class="w-full border rounded px-3 py-2" required>
                ...
                <div class="grid md:grid-cols-2 gap-3">
                    <x-field label="Alamat">
                        <textarea name="penjual[alamat_identitas5]" id="penjual_alamat" class="w-full border rounded px-3 py-2" required>{{ old('penjual.alamat_identitas5', $e['penjual']['alamat_identitas5'] ?? ($ent['penjual_alamat'] ?? '')) }}</textarea>
                    </x-field>
                    <x-field label="Negara">
                        <select name="penjual[kode_negara2]" id="penjual_negara"
                            class="w-full border rounded px-3 py-2">
                            <option value="">-- Pilih Negara --</option>
                            @foreach ($negaraOpts as $k => $v)
